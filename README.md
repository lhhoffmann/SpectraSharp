...
### 🎯 Learning Objectives
- **Modern .NET:** Leveraging the latest features of .NET 10 for maximum performance.
- **System Architecture:** Understanding how to structure large-scale software projects from scratch.
- **Infrastructure:** Applying my knowledge from my IT apprenticeship to software deployment and environment stability.

## 🛠 Tech Stack
- **Language:** C# 14
- **Runtime:** .NET 10
- **Focus:** Performance, scalability, and modular system design.
